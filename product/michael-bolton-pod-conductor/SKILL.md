...
description: "Trigger: product pod orchestration, cross-functional pod baton, software lifecycle orchestra, conduct product pod, PM design engineering data DS PMM handoff, multi-agent product development, autonomous software company orchestration, end-to-end feature lifecycle execution, product area pod, michael bolton pod conductor, delegate subagents with outcome constraints measures, deming system failure checklist. Scope: Master orchestrator conducting horizontal cross-functional product pods (Staff PM, Product Designer, Principal Engineer, Lead Data Scientist, Product Marketing Manager) following the Michael Bolton Rule (Mintzberg real-time roles, Deming systems thinking, March 70/20/10 portfolio). Sequences the 5-Movement Lifecycle Symphony: (1) Empirical Grounding & Sizing, (2) Discovery, Behavioral Loops & PRD, (3) Interface & Design System, (4) Contract-First Architecture & TDD Build, (5) Verification, Release Gating & Experiment Rollout. Enforces strict intent framing (Outcome, Constraints, Measures, Time-horizon) and blocking gate approvals. Boundary: Excludes single-task code implementation (use developer-development-rules or improve-codebase) or executive portfolio strategy planning (use decision-stack-governance)."
---
